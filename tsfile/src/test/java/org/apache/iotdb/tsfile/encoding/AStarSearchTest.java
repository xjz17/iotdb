...
public class AStarSearchTest {
  ...
  private static void permuteHelperBitWidth(
      ArrayList<ArrayList<Integer>> nums,
      boolean[] used,
  ...
  private static void permuteHelper1(
      ArrayList<ArrayList<Integer>> nums,
      boolean[] used,
      ArrayList<ArrayList<Integer>> current,
      ArrayList<ArrayList<ArrayList<Integer>>> result) {
  ...
  public static long ReorderingDeltaEncoder(
      ArrayList<ArrayList<Integer>> data, int block_size, double threshold, String dataset_name)
      throws IOException {
    block_size++;
