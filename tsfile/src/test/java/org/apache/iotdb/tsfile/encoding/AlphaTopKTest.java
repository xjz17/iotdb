...
public class AlphaTopKTest {
  ...
  public static void main(@org.jetbrains.annotations.NotNull String[] args) throws IOException {
    ...
    String output =
        "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\reorder\\result_evaluation\\compression_ratio\\ts2diff_topk\\";
    input_path_list.add(
    ...
    for (int file_i = 0; file_i < input_path_list.size(); file_i++) {
      ...
      for (File f : tempList) {
        ...
        inputStream.close();
        for (double threshold = 0.05; threshold < 0.06; threshold += 0.1) {
          long encodeTime = 0;
          long decodeTime = 0;
          double ratio = 0;
