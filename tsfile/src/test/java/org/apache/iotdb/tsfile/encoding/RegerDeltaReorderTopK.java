...
public class RegerDeltaReorderTopK {
...
//  }
    ...
    public static int getIStarThreshold(ArrayList<ArrayList<Integer>> ts_block, int block_size, double threshold) {
        ...
        int i_star_index = (int) ((double) epsilon_v_j_list.size() * threshold);
//        System.out.println("i_star_index:"+i_star_index);
...
//      encoded_result.addAll(cur_encoded_result);
    ...
    public static void main(@org.jetbrains.annotations.NotNull String[] args) throws IOException {
        ...
        String output =
                "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\vldb\\compression_ratio\\delta_reorder\\";
//    a_star_rubbish
