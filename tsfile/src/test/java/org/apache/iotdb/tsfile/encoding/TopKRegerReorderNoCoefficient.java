...
public class TopKRegerReorderNoCoefficient {
...
//        String output = "C:\\Users\\xiaoj\\Desktop\\test\\";
        String output =
                "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\vldb\\compression_ratio\\topk_reorder_no_coef\\";
...
//              buffer = ReorderingRegressionEncoder(data, dataset_block_size.get(file_i), threshold, dataset_name.get(file_i));
                    ...
                    String[] record = {
                            f.toString(),
                            "REGER-Reorder-TopK-No-Coefficient",
