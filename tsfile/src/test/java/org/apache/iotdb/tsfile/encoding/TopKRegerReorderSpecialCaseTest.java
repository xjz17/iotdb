...
public class TopKRegerReorderSpecialCaseTest {
        ...
        for (int j = 1; j < block_size; j++) {
            int epsilon_r =
                    ts_block.get(j).get(0)
                            - (theta0_r + theta1_r * ts_block.get(j - 1).get(0));
            int epsilon_v =
                    ts_block.get(j).get(1)
                            - (theta0_v + theta1_v * ts_block.get(j - 1).get(1));

            //      int epsilon_r = ts_block.get(j).get(0) - (int) (theta0_r + theta1_r *
            // (int)ts_block.get(j-1).get(0));
            //      int epsilon_v = ts_block.get(j).get(1) - (int) (theta0_v + theta1_v *
            // (int)ts_block.get(j-1).get(1));
        ...
        for (int j = block_size - 1; j > 0; j--) {
            ...
            int epsilon_r =
                    ts_block.get(j).get(0)
                            ...
                            + theta1_r * ts_block.get(j - 1).get(0));
            int epsilon_v =
                    ts_block.get(j).get(1)
                            - (theta0_v + value_delta_min
                            + theta1_v * ts_block.get(j - 1).get(1));
...
//  }
    ...
    private static ArrayList<Integer> adjustTo0(ArrayList<ArrayList<Integer>> ts_block, int alpha, double threshold, ArrayList<Integer> theta) {
            ...
            if (i == (alpha + 1)) {
                timestamp_delta_i =
                        ts_block.get(alpha + 1).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(alpha - 1).get(0));
                value_delta_i =
                        ts_block.get(alpha + 1).get(1)
                                -  (theta0_v + theta1_v *  ts_block.get(alpha - 1).get(1));
            } else if (i == alpha) {
                timestamp_delta_i =
                        ts_block.get(0).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(alpha).get(0));
                value_delta_i =
                        ts_block.get(0).get(1)
                                -  (theta0_v + theta1_v *  ts_block.get(alpha).get(1));
            } else {
                timestamp_delta_i =
                        ts_block.get(i).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(i - 1).get(0));
                value_delta_i =
                        ts_block.get(i).get(1)
                                -  (theta0_v + theta1_v *  ts_block.get(i - 1).get(1));
            }
    ...
    private static ArrayList<Integer> adjustTon(ArrayList<ArrayList<Integer>> ts_block, int alpha, double threshold, ArrayList<Integer> theta) {
        int block_size = ts_block.size();
        assert alpha != block_size - 1;
        assert alpha != 0;
        ArrayList<Integer> b = new ArrayList<>();
            ...
            if (i == (alpha + 1)) {
                ...
                timestamp_delta_i =
                        ts_block.get(alpha).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(block_size - 1).get(0));
                value_delta_i =
                        ts_block.get(alpha).get(1)
                                -  (theta0_v + theta1_v *  ts_block.get(block_size - 1).get(1));
            } else {
                timestamp_delta_i =
                        ts_block.get(i).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(i - 1).get(0));
    ...
    private static ArrayList<Integer> adjustAlphaToJ(
            ArrayList<ArrayList<Integer>> ts_block, int alpha, int j, double threshold, ArrayList<Integer> theta) {
        ...
        for (int i = 1; i < block_size; i++) {
            ...
            if (i == j) {
                ...
                timestamp_delta_i =
                        ts_block.get(alpha).get(0)
                                -  (theta0_t + theta1_t *  ts_block.get(j - 1).get(0));
                value_delta_i =
                        ts_block.get(alpha).get(1)
                                -  (theta0_v + theta1_v *  ts_block.get(j - 1).get(1));
            } else if (i == alpha + 1) {
    ...
    // adjust n to 0
    private static ArrayList<Integer> adjustn0(ArrayList<ArrayList<Integer>> ts_block, double threshold, ArrayList<Integer> theta) {
        int block_size = ts_block.size();
        ArrayList<Integer> b = new ArrayList<>();
        int timestamp_delta_max = Integer.MIN_VALUE;
        int value_delta_max = Integer.MIN_VALUE;
        ...
        for (int i = 1; i < block_size - 1; i++) {
            ...
            int value_delta_i;
            timestamp_delta_i =
                    ts_block.get(i).get(0) -  (theta0_t + theta1_t *  ts_block.get(i - 1).get(0));
            value_delta_i =
                    ts_block.get(i).get(1) -  (theta0_v + theta1_v *  ts_block.get(i - 1).get(1));
    ...
    // adjust 0 to n
    private static ArrayList<Integer> adjust0n1(ArrayList<ArrayList<Integer>> ts_block, double threshold, ArrayList<Integer> theta) {
        int block_size = ts_block.size();
        ArrayList<Integer> b = new ArrayList<>();
        int timestamp_delta_min = Integer.MAX_VALUE;
        int value_delta_min = Integer.MAX_VALUE;
    ...
    public static int getIStarThreshold(ArrayList<ArrayList<Integer>> ts_block, int block_size, int index, double threshold, ArrayList<Integer> theta) {
        int timestamp_delta_max = Integer.MIN_VALUE;
        int value_delta_max = Integer.MIN_VALUE;
        int timestamp_delta_max_index = -1;
        int value_delta_max_index = -1;
        ...
        if (index == 0) {
            ArrayList<ArrayList<Integer>> epsilon_v_j_list = new ArrayList<>();
            int epsilon_v_j = ts_block.get(1).get(1) -  (theta0_v + theta1_v *  ts_block.get(0).get(1));
            ArrayList<Integer> tmp = new ArrayList<>();
            tmp.add(1);
            tmp.add(epsilon_v_j);
            epsilon_v_j_list.add(tmp);
            for (int j = 2; j < block_size; j++) {
                epsilon_v_j = ts_block.get(j).get(1) -  (theta0_v + theta1_v *  ts_block.get(j - 1).get(1));
                tmp = new ArrayList<>();
                tmp.add(j);
                tmp.add(epsilon_v_j);
                // 寻找插入位置
            ...
            ArrayList<ArrayList<Integer>> epsilon_v_j_list = new ArrayList<>();
            int epsilon_r_j = ts_block.get(1).get(0) -  (theta0_t + theta1_t *  ts_block.get(0).get(0));
            ArrayList<Integer> tmp = new ArrayList<>();
            tmp.add(1);
            tmp.add(epsilon_r_j);
            epsilon_v_j_list.add(tmp);
            for (int j = 2; j < block_size; j++) {
                epsilon_r_j = ts_block.get(j).get(0) -  (theta0_t + theta1_t *  ts_block.get(j - 1).get(0));
                tmp = new ArrayList<>();
                tmp.add(j);
                tmp.add(epsilon_r_j);
                // 寻找插入位置
    ...
    public static int getIStarThreshold(ArrayList<ArrayList<Integer>> ts_block, int block_size, double threshold, ArrayList<Integer> theta) {
        int timestamp_delta_min = Integer.MAX_VALUE;
        int value_delta_min = Integer.MAX_VALUE;
        int timestamp_delta_max = Integer.MIN_VALUE;
        int value_delta_max = Integer.MIN_VALUE;
    ...
    public static int getJStarThreshold(
        ...
        ArrayList<ArrayList<Integer>> epsilon_r_j_list = new ArrayList<>();
        ArrayList<ArrayList<Integer>> epsilon_v_j_list = new ArrayList<>();
        int delta_t_i = ts_block.get(1).get(0) -  (theta0_t + theta1_t *  ts_block.get(0).get(0));
        int delta_v_i = ts_block.get(1).get(1) -  (theta0_v + theta1_v *  ts_block.get(0).get(1));
        ArrayList<Integer> tmp = new ArrayList<>();
        tmp.add(1);
        tmp.add(delta_t_i);
        epsilon_r_j_list.add(tmp);
        ...
        for (int i = 2; i < block_size; i++) {
            delta_t_i = ts_block.get(i).get(0) -  (theta0_t + theta1_t *  ts_block.get(i - 1).get(0));
            delta_v_i = ts_block.get(i).get(1) -  (theta0_v + theta1_v *  ts_block.get(i - 1).get(1));
            if (delta_t_i < timestamp_delta_min) {
                timestamp_delta_min = delta_t_i;
            }
            if (delta_v_i < value_delta_min) {
...
//        for (byte b : theta1_v_byte) encoded_result.add(b);
    ...
    public static ArrayList<ArrayList<Integer>> getAbsDeltaTsBlock(
            ArrayList<ArrayList<Integer>> ts_block, ArrayList<Integer> result, ArrayList<Integer> theta) {
        ArrayList<ArrayList<Integer>> ts_block_delta = new ArrayList<>();
        ArrayList<Integer> tmp = new ArrayList<>();
...
//System.out.println(theta);
        ...
        int value_delta_min = Integer.MAX_VALUE;
        for (int i = 1; i < ts_block.size(); i++) {
//            int epsilon_r = abs(ts_block.get(i).get(0) -  (theta0_t + theta1_t *  ts_block.get(i - 1).get(0)));
//            int epsilon_v = abs(ts_block.get(i).get(1) -  (theta0_v + theta1_v *  ts_block.get(i - 1).get(1)));

            int epsilon_r = ts_block.get(i).get(0) -  ( theta0_t +  theta1_t *  ts_block.get(i - 1).get(0));
            int epsilon_v = ts_block.get(i).get(1) -  ( theta0_v +  theta1_v *  ts_block.get(i - 1).get(1));
            if(epsilon_r< timestamp_delta_min){
                timestamp_delta_min = epsilon_r;
            }
            if(epsilon_v<value_delta_min){
...
//            int epsilon_v = abs(ts_block.get(i).get(1) -  (theta0_v + theta1_v *  ts_block.get(i - 1).get(1)));
            ...
            int epsilon_r =
                    ts_block.get(i).get(0)
                            -
                            (theta0_t + timestamp_delta_min
                                    +  theta1_t *  ts_block.get(i - 1).get(0));
            int epsilon_v =
                    ts_block.get(i).get(1)
                            -
                            ( (theta0_v + value_delta_min)
                                    +  theta1_v *  ts_block.get(i - 1).get(1));
...
//                tmp.add(ts_block.get(i).get(0) -  ((int) theta0_t +  theta1_t *  ts_block.get(i - 1).get(0)));
//                tmp.add(ts_block.get(i).get(1) -  ((int) theta0_v +  theta1_v *  ts_block.get(i - 1).get(1)));
                outlier_top_k.add(tmp);
            } else {
                epsilon_r = ts_block.get(i).get(0) -  ( theta0_t +  theta1_t *  ts_block.get(i - 1).get(0));
                epsilon_v = ts_block.get(i).get(1) -  ( theta0_v +  theta1_v *  ts_block.get(i - 1).get(1));
                if (epsilon_r < timestamp_delta_min) {
                    timestamp_delta_min = epsilon_r;
//                System.out.println("timestamp_delta_min: "+timestamp_delta_min);
...
//        System.out.println("timestamp_delta_min in getDeltaTsBlock:"+timestamp_delta_min);
//        System.out.println("value_delta_min in getDeltaTsBlock:"+value_delta_min);

        for (int j = ts_block.size() - 1; j > 0; j--) {

            if (!outlier_top_k_index.contains(j)) {
//                if(ts_block_delta.get(j).get(0) == 43){
////                    System.out.println("ts_block_delta.get(j)"+ts_block_delta.get(j));
//                }
                int epsilon_r =
                        ts_block.get(j).get(0)
                                -
                                ( (theta0_t + timestamp_delta_min)
                                        +  theta1_t *  ts_block.get(j - 1).get(0));
                int epsilon_v =
                        ts_block.get(j).get(1)
                                -
                                ( (theta0_v + value_delta_min)
...
//        System.out.println("value_delta_min: "+value_delta_min);
//
//        System.out.println("timestamp_delta_max in getDeltaTsBlock:"+timestamp_delta_max);
//        System.out.println("value_delta_max in getDeltaTsBlock:"+value_delta_max);
        result.add(timestamp_delta_min);
        result.add(value_delta_min);
    ...
    public static ArrayList<Byte> encodeDeltaTsBlock(
            ArrayList<ArrayList<Integer>> ts_block_delta, ArrayList<Integer> result, int t_or_v, ArrayList<Integer> theta) {
        ArrayList<Byte> encoded_result = new ArrayList<>();
...
//        System.out.println(t_or_v+" max_bit_width: "+getBitWith(max_interval));
...
//        for (ArrayList<Integer> integers : outlier_top_k) {
    ...
    public static long getOutlier(
            ArrayList<ArrayList<Integer>> ts_block, ArrayList<Integer> raw_length, double threshold, int t_or_v, ArrayList<Integer> theta) {
...
//        System.out.println(ts_block_delta);
        ...
        // i_star_ready);
//        System.out.println(t_or_v + " cur_encoded_result.size():" + cur_encoded_result.size());
        bits_encoded_data += (cur_encoded_result.size() * 8L);
//        System.out.println(t_or_v + "bits_encoded_data:" + bits_encoded_data);
...
//        }
//
//        System.out.println(t_or_v + "bits_encoded_data:" + getBitwidthDeltaTsBlock(outlier_top_k, t_or_v));
...
//        for(int i=74;i<75;i++){
        for (int i = 0; i < block_num; i++) {
            ...
            ArrayList<ArrayList<Integer>> ts_block_delta = getEncodeBitsRegression(ts_block, block_size, raw_length, i_star_ready, theta,threshold);
            ...
            ArrayList<ArrayList<Integer>> ts_block_delta_reorder = getEncodeBitsRegression(ts_block, block_size, reorder_length, i_star_ready_reorder, theta_reorder,threshold);
...
//                System.out.println("i_star"+i_star);
                getEncodeBitsRegression(ts_block, block_size, raw_length, i_star_ready_reorder, theta,threshold);
...
//            bits_encoded_data += 32; // others block size
//            System.out.println("cur_bits:"+cur_bits);
...
//        System.out.println("cur_bits:"+bits_encoded_data);
        ...
        if (remaining_length != 0 && remaining_length != 1) {
            ...
            ArrayList<ArrayList<Integer>> ts_block_delta =
                    getEncodeBitsRegression(ts_block, remaining_length, raw_length, i_star_ready, theta,threshold);
            ...
            ArrayList<ArrayList<Integer>> ts_block_delta_reorder =
                    getEncodeBitsRegression(
                            ts_block, remaining_length, reorder_length, i_star_ready_reorder, theta_reorder,threshold);
            ...
            ts_block_delta =
                    getEncodeBitsRegression(
                            ts_block, remaining_length, raw_length, i_star_ready_reorder, theta,threshold);
            int supple_length;
...
//        String output = "C:\\Users\\xiaoj\\Desktop\\test\\";
        String output = "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\vldb\\compression_ratio\\topk_reorder_special\\";
...
//        dataset_block_size.add(256);
        ...
        for (int file_i = 5; file_i < 10; file_i++) {
