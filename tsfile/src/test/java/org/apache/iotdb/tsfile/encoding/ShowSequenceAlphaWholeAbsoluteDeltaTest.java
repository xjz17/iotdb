...
//    System.out.println("0) abs(ts_block.get(j).get(1) -   ts_block.get(alpha).get(1)) = "+(abs(ts_block.get(j).get(1) -   ts_block.get(alpha).get(1))));
//    System.out.println("0) abs(ts_block.get(alpha).get(1) - ts_block.get(j-1).get(1)) = "+(abs(ts_block.get(alpha).get(1) - ts_block.get(j-1).get(1))));
//    System.out.println("0) abs(ts_block.get(alpha+1).get(1) - ts_block.get(alpha-1).get(1)) = "+(abs(ts_block.get(alpha+1).get(1) - ts_block.get(alpha-1).get(1))));
...
//    System.out.println("j = "+j);
//    System.out.println("alpha = "+alpha);
//    System.out.println("1) abs(ts_block.get(j).get(1) -   ts_block.get(j-1).get(1)) = "+(abs(ts_block.get(j).get(1) -   ts_block.get(j-1).get(1))));
//    System.out.println("1) abs(ts_block.get(alpha).get(1) -   ts_block.get(alpha-1).get(1)) = "+(abs(ts_block.get(alpha).get(1) -   ts_block.get(alpha-1).get(1))));
//    System.out.println("1) abs(ts_block.get(alpha+1).get(1) - ts_block.get(alpha).get(1)) = "+(abs(ts_block.get(alpha+1).get(1) - ts_block.get(alpha).get(1))));
...
//          if( (b.get(0)+b.get(1) < raw_bit_width_timestamp_sum_delta+raw_bit_width_value_sum_delta)){
        ...
        if(beta_star != -1){
          if(change_pos != alpha-beta_star){
            ...
            System.out.println("alpha:"+alpha+"(Move back "+ (alpha-beta_star) +" positions)"+"->"+"beta:"+beta_star);
...
//          if( (b.get(0)+b.get(1) < raw_bit_width_timestamp_sum_delta+raw_bit_width_value_sum_delta)){
      ...
      if(beta_star != -1){
        if(change_pos != block_size-beta_star-1){
          ...
          System.out.println("alpha:"+(block_size-1)+"(Move back "+ (block_size-1-beta_star) +" positions)"+"->"+"beta:"+beta_star);
      ...
      printTSBlock(ts_block,"C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\vldb\\test_top_k\\"+dataset+"2.csv");
