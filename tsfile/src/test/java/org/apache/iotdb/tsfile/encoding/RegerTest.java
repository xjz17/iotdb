...
public class RegerTest {
  ...
  public static ArrayList<Byte> ReorderingRegressionEncoder(
      ArrayList<ArrayList<Integer>> data, int block_size, String dir) throws IOException {
    block_size++;
    ...
    String[] head = {"Timestamp bit width", "Value bit width"};
  ...
  public static void main(@org.jetbrains.annotations.NotNull String[] args) throws IOException {
    String bit_width_str =
        "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\vldb\\bit-width\\";
          ...
          for (int repeat = 0; repeat < repeatTime2; repeat++)
            buffer =
                ReorderingRegressionEncoder(
                    data, dataset_block_size.get(file_i), bit_width_str_list.get(file_i));
