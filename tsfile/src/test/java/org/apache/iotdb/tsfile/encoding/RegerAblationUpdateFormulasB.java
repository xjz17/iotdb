...
public class RegerAblationUpdateFormulasB {
  ...
  public static int getJStarB(ArrayList<ArrayList<Integer>> ts_block, int alpha, int block_size,
                             ArrayList<Integer> raw_length, int index, ArrayList<Float> theta){
    int timestamp_delta_min = Integer.MAX_VALUE;
    int value_delta_min = Integer.MAX_VALUE;
    int raw_timestamp_delta_max = Integer.MIN_VALUE;
...
//      result2.add(1);
      ...
      j_star =getJStarB(ts_block,i_star,block_size,raw_length,0,theta);
...
//    String parent_dir = "C:\\Users\\xiaoj\\Desktop\\test";
    String parent_dir = "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\reorder\\result_evaluation\\ablationUpdate\\REGER-B";
