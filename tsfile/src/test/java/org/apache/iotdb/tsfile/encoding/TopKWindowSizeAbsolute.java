...
public class TopKWindowSizeAbsolute {
  ...
  public static ArrayList<ArrayList<Integer>> getAbsDeltaTsBlock(
    ...
    int value_delta_min = Integer.MAX_VALUE;
    for (int i = 1; i < ts_block.size(); i++) {
      int epsilon_r = Math.abs(ts_block.get(i).get(0) - ts_block.get(i - 1).get(0));
      int epsilon_v = Math.abs(ts_block.get(i).get(1) - ts_block.get(i - 1).get(1));
  ...
  private static ArrayList<Integer> getSumBitWidth(ArrayList<ArrayList<Integer>> ts_block) {
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      int value_delta_i;
      timestamp_delta_i = Math.abs(ts_block.get(i).get(0) - ts_block.get(i - 1).get(0));
      value_delta_i = Math.abs(ts_block.get(i).get(1) - ts_block.get(i - 1).get(1));
  ...
  public static long getEncodeDeltaTsBlock(
      ArrayList<ArrayList<Integer>> ts_block_delta, ArrayList<Integer> result) {
    ArrayList<Byte> encoded_result = new ArrayList<>();
    long getEncodeDeltaTsBlockBits = 0;
    ...
    //    byte[] td_common_byte = int2Bytes(result2.get(0));
    //    for (byte b: td_common_byte) encoded_result.add(b);
    getEncodeDeltaTsBlockBits +=
        ((long) (getBitWith(max_interval) + getBitWith(max_value)) * ts_block_delta.size());
    return getEncodeDeltaTsBlockBits;
  }

  public static int getDeltaTsBlockTime(
      ArrayList<ArrayList<Integer>> ts_block_delta, ArrayList<Integer> result) {
    int max_interval = Integer.MIN_VALUE;
    int max_value = Integer.MIN_VALUE;
    int block_size = ts_block_delta.size();
    ...
    return getBitWith(max_interval);
  }
  ...
  public static int getJStar(
    ...
    for (int i = 1; i < block_size; i++) {
      int delta_t_i = Math.abs(ts_block.get(i).get(0) - ts_block.get(i - 1).get(0));
      int delta_v_i = Math.abs(ts_block.get(i).get(1) - ts_block.get(i - 1).get(1));
  ...
  private static ArrayList<Integer> adjustTon(ArrayList<ArrayList<Integer>> ts_block, int alpha) {
    ...
    for (int i = 1; i < block_size; i++) {
      ...
      int value_delta_i;
      if (i == (alpha + 1)) {
        timestamp_delta_i = Math.abs(ts_block.get(alpha + 1).get(0) - ts_block.get(alpha - 1).get(0));
        value_delta_i = Math.abs(ts_block.get(alpha + 1).get(1) - ts_block.get(alpha - 1).get(1));
      } else if (i == alpha) {
        timestamp_delta_i = Math.abs(ts_block.get(alpha).get(0) - ts_block.get(block_size - 1).get(0));
        value_delta_i = Math.abs(ts_block.get(alpha).get(1) - ts_block.get(block_size - 1).get(1));
      } else {
        timestamp_delta_i = Math.abs(ts_block.get(i).get(0) - ts_block.get(i - 1).get(0));
        value_delta_i = Math.abs(ts_block.get(i).get(1) - ts_block.get(i - 1).get(1));
      }
  ...
  private static ArrayList<Integer> adjustTo0(ArrayList<ArrayList<Integer>> ts_block, int alpha) {
    ...
    int timestamp_delta_i;
    int value_delta_i;
    timestamp_delta_i = Math.abs(ts_block.get(0).get(0) - ts_block.get(alpha).get(0));
    value_delta_i = Math.abs(ts_block.get(0).get(1) - ts_block.get(alpha).get(1));
    raw_bit_width_timestamp_sum += timestamp_delta_i;
    raw_bit_width_value_sum += value_delta_i;
  ...
  private static ArrayList<Integer> adjustAlphaToJ(
    ...
    for (int i = 1; i < alpha; i++) {
      ...
      int value_delta_i;
      if (i == j) {
        timestamp_delta_i = Math.abs(ts_block.get(j).get(0) - ts_block.get(alpha).get(0));
        value_delta_i = Math.abs(ts_block.get(j).get(1) - ts_block.get(alpha).get(1));
        raw_bit_width_timestamp_sum += timestamp_delta_i;
        raw_bit_width_value_sum += value_delta_i;
        timestamp_delta_i = Math.abs(ts_block.get(alpha).get(0) - ts_block.get(j - 1).get(0));
        value_delta_i = Math.abs(ts_block.get(alpha).get(1) - ts_block.get(j - 1).get(1));
      } else {
        timestamp_delta_i = Math.abs(ts_block.get(i).get(0) - ts_block.get(i - 1).get(0));
        value_delta_i = Math.abs(ts_block.get(i).get(1) - ts_block.get(i - 1).get(1));
      }
  ...
  private static ArrayList<Integer> adjustTo0Delta(
    ...
    int raw_bit_width_timestamp_sum = 0;
    int raw_bit_width_value_sum = 0;
    raw_bit_width_timestamp_sum += Math.abs(ts_block.get(0).get(0) - ts_block.get(alpha).get(0));
    raw_bit_width_value_sum += Math.abs(ts_block.get(0).get(1) - ts_block.get(alpha).get(1));

    raw_bit_width_timestamp_sum -= Math.abs(ts_block.get(alpha).get(0) - ts_block.get(alpha - 1).get(0));
    ;
    raw_bit_width_value_sum -= Math.abs(ts_block.get(alpha).get(1) - ts_block.get(alpha - 1).get(1));
  ...
  private static ArrayList<Integer> adjustAlphaToJDelta(
    ...
    delta_raw_bit_width_timestamp_sum += Math.abs(ts_block.get(j).get(0) - ts_block.get(alpha).get(0));
    delta_raw_bit_width_value_sum += Math.abs(ts_block.get(j).get(1) - ts_block.get(alpha).get(1));

    delta_raw_bit_width_timestamp_sum +=
        Math.abs(ts_block.get(alpha).get(0) - ts_block.get(j - 1).get(0));
    delta_raw_bit_width_value_sum += Math.abs(ts_block.get(alpha).get(1) - ts_block.get(j - 1).get(1));

    delta_raw_bit_width_timestamp_sum -= Math.abs(ts_block.get(j).get(0) - ts_block.get(j - 1).get(0));
    delta_raw_bit_width_value_sum -= Math.abs(ts_block.get(j).get(1) - ts_block.get(j - 1).get(1));

    delta_raw_bit_width_timestamp_sum -=
        Math.abs(ts_block.get(alpha).get(0) - ts_block.get(alpha - 1).get(0));
    delta_raw_bit_width_value_sum -=
        Math.abs(ts_block.get(alpha).get(1) - ts_block.get(alpha - 1).get(1));
  ...
  private static ArrayList<Integer> adjustn0(ArrayList<ArrayList<Integer>> ts_block) {
    ...
    int timestamp_delta_i;
    int value_delta_i;
    timestamp_delta_i = Math.abs(ts_block.get(0).get(0) - ts_block.get(block_size - 1).get(0));
    value_delta_i = Math.abs(ts_block.get(0).get(1) - ts_block.get(block_size - 1).get(1));
    raw_bit_width_timestamp_sum += timestamp_delta_i;
    raw_bit_width_value_sum += value_delta_i;
  ...
  private static int getIstarClose(int alpha, ArrayList<Integer> j_star_list) {
    ...
    for (int i : j_star_list) {
      if (Math.abs(alpha - i) < min_dis) {
        min_i = i;
        min_dis = Math.abs(alpha - i);
      }
    }
    if (min_dis == 0) {
  ...
  public static long getTopKBits(
    ...
    long cur_encoded_result = getEncodeDeltaTsBlock(ts_block_delta, raw_length);
    bits_encoded_data += cur_encoded_result;
    ...
    //    System.out.println("encoded bits:"+(outlier_bits + cur_encoded_result.size() * 8L));
  ...
  public static long ReorderingDeltaEncoder(
    ...
    for (int i = 0; i < block_num; i++) {
      ...
      //      System.out.println(ts_block_delta_raw);
      ...
      int bit_width_time = getDeltaTsBlockTime(ts_block_delta_raw, result);
      ...
      System.out.println("bit_width_time: " + bit_width_time);
      for (int w = bit_width_time + 4; w < bit_width_time + 5; w++) {
        int interval_time = (int) (Math.pow(2, w) - 1);
        System.out.println("length:" + raw_order_index.size());
        int alpha = 0;
        raw_order_index.remove(0);
        ArrayList<Integer> reorder = new ArrayList<>();
        reorder.add(alpha);
        int next_alpha = alpha + 1;
        ArrayList<Integer> outlier_top_k_index = new ArrayList<>();
        ...
        while (raw_order_index.size() > 0) {
          ...
          if (alpha == block_size - 1) break;
          int min_value_delta = Integer.MAX_VALUE / 2;
          for (int raw_order_index_j : raw_order_index) {
            ArrayList<Integer> cur_next = ts_block.get(raw_order_index_j);
            if (cur_next.get(0) - cur.get(0) > interval_time) {
              //              System.out.println(raw_order_index_j);
              //              System.out.println(alpha);
              break;
            } else if (cur.get(0) - cur_next.get(0) > interval_time) {
              continue;
            }
            int cur_value_delta = Math.abs(cur_next.get(1) - cur.get(1));
            if (cur_value_delta < min_value_delta) {
              min_value_delta = cur_value_delta;
              next_alpha_list.clear();
              next_alpha_list.add(raw_order_index_j);
            } else if (cur_value_delta == min_value_delta) {
              next_alpha_list.add(raw_order_index_j);
            }
          }
          //          System.out.println(next_alpha_list);

          if (next_alpha_list.size() == 0) {
            alpha = alpha + 1;
          } else {
            alpha = getIstarClose(alpha, next_alpha_list);
            //            System.out.println("move: "+alpha);
          }
          //          System.out.println(alpha);
          reorder.add(alpha);
        ...
        ts_block_reordering = new ArrayList<>();
        System.out.println(reorder);
        System.out.println("length:" + reorder.size());
        for (int index : reorder) {
          ts_block_reordering.add(ts_block.get(index));
        }
        ArrayList<ArrayList<Integer>> ts_block_remaining = new ArrayList<>();
        for (int index : raw_order_index) {
          ts_block_remaining.add(ts_block.get(index));
        }
        long ts_block_reordering_bits = getTopKBits(ts_block_reordering, raw_length, threshold);
        long ts_block_remaining_bits = 0;
        if (raw_order_index.size() != 0)
          ts_block_remaining_bits = getTopKBits(ts_block_remaining, raw_length, threshold);
        bits_encoded_data += ts_block_reordering_bits;
        bits_encoded_data += ts_block_remaining_bits;
      }
  ...
  public static void main(@org.jetbrains.annotations.NotNull String[] args) throws IOException {
    ...
    String output =
        "C:\\Users\\xiaoj\\Documents\\GitHub\\encoding-reorder\\reorder\\result_evaluation\\compression_ratio\\top_k_1nn_ws\\";
    ...
    for (int file_i = 4; file_i < 5; file_i++) {
      ...
      for (File f : tempList) {
        ...
        inputStream.close();
        //        double threshold=0;
        for (double threshold = 0; threshold < 0.001; threshold += 0.01) {
          long encodeTime = 0;
          long decodeTime = 0;
          double ratio = 0;
