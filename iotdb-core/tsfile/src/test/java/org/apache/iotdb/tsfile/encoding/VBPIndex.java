...
public class VBPIndex {
     ...
     */
    public VBPIndex(int kBits, int[] codes) {
        // if (kBits <= 0 || kBits >= W) {
    ...
    private BitSet selectInternal(HBPIndex.Op op, int Ck) {
    ...
    public static void main(String[] args) {
        int k = 3;
        int[] codes = {1, 5, 6, 1, 6, 4, 0, 7, 4, 3};
        VBPIndex idx = new VBPIndex(k, codes);
