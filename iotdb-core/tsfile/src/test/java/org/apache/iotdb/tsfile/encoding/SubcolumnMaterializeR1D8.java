...
//                System.out.println("BitSet1: "+b1.cardinality());
//                System.out.println("BitSet2: "+b2.cardinality());
                b1.and(b2); // intersection
                int match = b1.cardinality(); // 匹配数量
//                System.out.println("match: "+match);
//                System.out.println("match ratio: "+(double)match/(double)(b1.cardinality()+b2.cardinality()-match));
