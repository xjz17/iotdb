    ...
    public void testParts() throws IOException {
        ...
        for (File file : csvFiles) {
            ...
            for (int repeat = 0; repeat < repeatTime; repeat++) {
                ...
                length = VBPQuerySmallerPartsTest.Encoder(col1_data, block_size, indexList1, encoded_result1);

                length = VBPQuerySmallerPartsTest.Encoder(col2_data, block_size, indexList2, encoded_result2);
            }
