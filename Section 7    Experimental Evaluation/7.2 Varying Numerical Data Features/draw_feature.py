...
f = sns.lineplot(x="Data Mean",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fig.subplots_adjust(hspace=0.2)
fig.subplots_adjust(wspace=0.37)
fmri = pd.read_csv("result_delta_var_ratio.csv")
