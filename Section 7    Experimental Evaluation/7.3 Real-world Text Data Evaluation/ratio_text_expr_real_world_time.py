...
logger = open(RESULT1_PATH, "w")
logger.write("DataFile,Compression,Encoding,Insert Time,Select Time\n")
    ...
    for compressor in compressors:
        for encoding in encodings:
            ...
            if compressor.name == "UNCOMPRESSED":
                logger.write("{},{},{},{},{}\n".format(dataFile, "NONE", encoding.name,insert_time,select_time))
            else:
                logger.write("{},{},{},{},{}\n".format(dataFile, compressor.name, encoding.name,insert_time,select_time))
