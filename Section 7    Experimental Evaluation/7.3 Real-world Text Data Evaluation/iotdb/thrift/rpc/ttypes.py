...
class TSCreateMultiTimeseriesReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i481 in range(_size477):
                        ...
                        self.dataTypes.append(_elem482)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i487 in range(_size483):
                        ...
                        self.encodings.append(_elem488)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i493 in range(_size489):
                        _elem494 = iprot.readI32()
                        self.compressors.append(_elem494)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i499 in range(_size495):
                        ...
                        for _i505 in range(_size501):
                            ...
                            _elem500[_key506] = _val507
                        iprot.readMapEnd()
                        self.propsList.append(_elem500)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i512 in range(_size508):
                        ...
                        for _i518 in range(_size514):
                            ...
                            _val520 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _elem513[_key519] = _val520
                        iprot.readMapEnd()
                        self.tagsList.append(_elem513)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i525 in range(_size521):
                        ...
                        for _i531 in range(_size527):
                            _key532 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val533 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _elem526[_key532] = _val533
                        iprot.readMapEnd()
                        self.attributesList.append(_elem526)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i538 in range(_size534):
                        ...
                        self.measurementAliasList.append(_elem539)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataTypes is not None:
            ...
            oprot.writeListBegin(TType.I32, len(self.dataTypes))
            for iter541 in self.dataTypes:
                oprot.writeI32(iter541)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encodings is not None:
            oprot.writeFieldBegin('encodings', TType.LIST, 4)
            oprot.writeListBegin(TType.I32, len(self.encodings))
            for iter542 in self.encodings:
        ...
        if self.compressors is not None:
            ...
            oprot.writeListBegin(TType.I32, len(self.compressors))
            for iter543 in self.compressors:
        ...
        if self.propsList is not None:
            ...
            for iter544 in self.propsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter544))
                for kiter545, viter546 in iter544.items():
                    oprot.writeString(kiter545.encode('utf-8') if sys.version_info[0] == 2 else kiter545)
                    oprot.writeString(viter546.encode('utf-8') if sys.version_info[0] == 2 else viter546)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tagsList is not None:
            ...
            oprot.writeListBegin(TType.MAP, len(self.tagsList))
            for iter547 in self.tagsList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter547))
                for kiter548, viter549 in iter547.items():
                    oprot.writeString(kiter548.encode('utf-8') if sys.version_info[0] == 2 else kiter548)
                    oprot.writeString(viter549.encode('utf-8') if sys.version_info[0] == 2 else viter549)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.attributesList is not None:
            ...
            oprot.writeListBegin(TType.MAP, len(self.attributesList))
            for iter550 in self.attributesList:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter550))
                for kiter551, viter552 in iter550.items():
        ...
        if self.measurementAliasList is not None:
            ...
            for iter553 in self.measurementAliasList:
...
class ServerProperties(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i558 in range(_size554):
                        ...
                        self.supportedTimeAggregationOperations.append(_elem559)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.supportedTimeAggregationOperations is not None:
            ...
            for iter560 in self.supportedTimeAggregationOperations:
...
class TSAppendSchemaTemplateReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i565 in range(_size561):
                        ...
                        self.measurements.append(_elem566)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i571 in range(_size567):
                        ...
                        self.dataTypes.append(_elem572)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i577 in range(_size573):
                        ...
                        self.encodings.append(_elem578)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i583 in range(_size579):
                        ...
                        self.compressors.append(_elem584)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.measurements is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.measurements))
            for iter585 in self.measurements:
        ...
        if self.compressors is not None:
            ...
            oprot.writeListBegin(TType.I32, len(self.compressors))
            for iter588 in self.compressors:
                oprot.writeI32(iter588)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSQueryTemplateResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i593 in range(_size589):
                        ...
                        self.measurements.append(_elem594)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.measurements is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.measurements))
            for iter595 in self.measurements:
...
class TSConnectionInfoResp(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i600 in range(_size596):
                        _elem601 = TSConnectionInfo()
                        _elem601.read(iprot)
                        self.connectionInfoList.append(_elem601)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.connectionInfoList is not None:
            ...
            for iter602 in self.connectionInfoList:
                iter602.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
