...
fmri = pd.read_csv("result/time_data/mean_int.csv")
...
f_title.set_fontsize(30)
# f.set_ylim(0,0.16)
fmri = pd.read_csv("result/time_data/diffmean_int.csv")
...
f_title.set_fontsize(30)
# f.set_ylim(0,0.16)
fmri = pd.read_csv("result/time_data/diffvar_int.csv")
...
f_title.set_fontsize(30)
# f.set_ylim(0,0.16)
fmri = pd.read_csv("result/time_data/repeat_int.csv")
...
f_title.set_fontsize(30)
# f.set_ylim(0,0.16)
fmri = pd.read_csv("result/time_data/increase_int.csv")
