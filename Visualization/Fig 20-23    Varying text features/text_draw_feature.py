...
f = sns.lineplot(x="Types",y="Compression Ratio",hue="Encoding",hue_order=["HUFFMAN","DICTIONARY","RLE","PLAIN"],
                       markers=['o','o','o','o'],err_style=None,style="Encoding",dashes=False,
                       palette=my_palette,data=fmri,ax=ax_arr[0],size='Encoding',sizes=[5,5,5,5])
...
f = sns.lineplot(x="Length",y="Compression Ratio",hue="Encoding",hue_order=["HUFFMAN","DICTIONARY","RLE","PLAIN"],
                       markers=['o','o','o','o'],err_style=None,style="Encoding",dashes=False,
                       palette=my_palette,data=fmri,ax=ax_arr[0],size='Encoding',sizes=[5,5,5,5])
#sns.despine(offset=10, trim=True)
f.get_legend().remove()
...
f = sns.lineplot(x="Repeat",y="Compression Ratio",hue="Encoding",hue_order=["HUFFMAN","DICTIONARY","RLE","PLAIN"],
                       markers=['o','o','o','o'],err_style=None,style="Encoding",dashes=False,
                       palette=my_palette,data=fmri,ax=ax_arr[0],size='Encoding',sizes=[5,5,5,5])
#sns.despine(offset=10, trim=True)
f.get_legend().remove()
...
f = sns.lineplot(x="Repeat",y="Insert Time",hue="Encoding",hue_order=["HUFFMAN","DICTIONARY","RLE","PLAIN"],
                       markers=['o','o','o','o'],err_style=None,style="Encoding",dashes=False,
                       palette=my_palette,data=fmri,ax=ax_arr[1],size='Encoding',sizes=[5,5,5,5])
#sns.despine(offset=10, trim=True)
f.get_legend().remove()
...
f.set_ylim(0,1)
f = sns.lineplot(x="Repeat",y="Select Time",hue="Encoding",hue_order=["HUFFMAN","DICTIONARY","RLE","PLAIN"],
                       markers=['o','o','o','o'],err_style=None,style="Encoding",dashes=False,
                       palette=my_palette,data=fmri,ax=ax_arr[2],size='Encoding',sizes=[5,5,5,5])
#sns.despine(offset=10, trim=True)
f.get_legend().remove()
