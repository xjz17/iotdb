...
fmri = pd.read_csv("result_repeat_int.csv")
...
fmri = pd.read_csv("result_repeat_long.csv")
...
fmri = pd.read_csv("result_repeat_float.csv")
f = sns.lineplot(x="Repeat",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fmri = pd.read_csv("result_repeat_double.csv")
f = sns.lineplot(x="Repeat",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
# plt.show()
fig.savefig("repeat_compression_ratio.eps",format='eps',dpi = 400,bbox_inches='tight')
fig.savefig("repeat_compression_ratio.png",dpi = 400,bbox_inches='tight')