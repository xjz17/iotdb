...
fmri = pd.read_csv("result_increase_int.csv")
...
fmri = pd.read_csv("result_increase_long.csv")
f = sns.lineplot(x="Increase",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fmri = pd.read_csv("result_increase_float.csv")
f = sns.lineplot(x="Increase",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fmri = pd.read_csv("result_increase_double.csv")
f = sns.lineplot(x="Increase",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
plt.show()
fig.savefig("increase.eps",format='eps',dpi = 400,bbox_inches='tight')
fig.savefig("increase.png",dpi = 400,bbox_inches='tight')
