...
fmri = pd.read_csv("result_diffmean_int.csv")
f = sns.lineplot(x="Delta mean",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
                      markers=['o','o','o','o','o','o','o'],style="Encoding",dashes=False, palette=["#a6cee3", "#b2df8a","#fb9a99", "#fdbf6f","#cab2d6", "#1f78b4","#33a02c"],data=fmri,ax=ax_arr[0][0],size='Encoding',sizes=[5,5,5,5,5,5,5])
...
fmri = pd.read_csv("result_diffmean_long.csv")
f = sns.lineplot(x="Delta mean",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fmri = pd.read_csv("result_diffmean_float.csv")
f = sns.lineplot(x="Delta mean",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
fmri = pd.read_csv("result_diffmean_double.csv")
f = sns.lineplot(x="Delta mean",y="Compression Ratio",hue="Encoding",hue_order=["TS_2DIFF","GORILLA","RAKE","RLE","RLBE","SPRINTZ","PLAIN"],
...
plt.show()
fig.savefig("diff_mean_compression_ratio.eps",format='eps',dpi = 400,bbox_inches='tight')
fig.savefig("diff_mean_compression_ratio.png", dpi = 400,bbox_inches='tight')
